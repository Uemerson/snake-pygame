...
def game_over(score):
    ...
    show_restart(red, "times", 20)
    show_score(0, red, "times", 20, score)
    pygame.display.flip()


def show_restart(color, font, size):
    restart_font = pygame.font.SysFont(font, size)
    restart_surface = restart_font.render("Press R to restart", True, color)
    restart_rect = restart_surface.get_rect()
    restart_rect.midtop = (frame_size_x / 2, frame_size_y / 1.05)
